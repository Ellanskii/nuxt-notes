 ...
 *
 * «Грязность» поля считаем по фокус-сессии, а не по состоянию истории:
 * пока в поле что-то набрали и фокус из него не уходил, нативная отмена
 * браузера остаётся приоритетной. Отслеживаем это через input, поэтому
